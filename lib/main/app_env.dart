...
abstract class EnvInfo {
  ...
  static String get connectionStrings => _environment._connectionString;
...
extension _EnvProperties on AppEnvironment {
  static const _appTitles = {
    AppEnvironment.DEV: 'Product Store (Dev)',
    AppEnvironment.STAGING: 'Product Store (Staging)',
    AppEnvironment.PROD: 'Product Store',
  };
