...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(email: $email, password: $password, name: $name, role: $role, avatar: $avatar, creationAt: $creationAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, name, role, avatar, creationAt, updatedAt);
